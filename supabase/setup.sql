...
-- concatenation of migrations/0001_init.sql and seed.sql, generated for
-- convenience — those two files remain the source of truth, so edit them and
-- regenerate rather than editing this one.
-- ===========================================================================
-- ===========================================================================
